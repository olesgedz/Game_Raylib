...
int main(void) {
  ...
  Model model = LoadModel("../../../assets/models/watermill.obj");          // Load model
  Texture2D texture = LoadTexture("../../../assets/models/watermill.obj");  // Load model texture
  ...
  while (!WindowShouldClose())  // Detect window close button or ESC key
  {
    ...
    DrawModel(model, position, 100.0f, WHITE);  // Draw 3d model with texture
