...
int main(void) {
  ...
  Model model = LoadModel("../../../assets/models/watermill.obj");                  // Load OBJ model
  Texture2D texture = LoadTexture("../../../assets/models/watermill_diffuse.png");  // Load model texture

  // Load shader for model
  // NOTE: Defining 0 (NULL) for vertex shader forces usage of internal default vertex shader
  Shader shader = LoadShader(0, "../../../assets/shaders/grayscale.fs");
